...
public class ExchangeAuditRequestMapper {
    ...
    public static String mapUnregisterService(String serviceName, String username) {
    ...
    public static String mapRemoveUnsentMessage(String guid , String username) {
