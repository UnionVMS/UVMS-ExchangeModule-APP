...
public interface ExchangeLogService {
    ...
    ExchangeLogType log(ExchangeBaseRequest request, LogType logType, ExchangeLogStatusTypeType status, TypeRefType messageType, String messageText, boolean incoming, String onValue, String todt, String to, String df) throws ExchangeLogException;
