...
public class RegistryBusEventListener implements MessageListener {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            errorEvent.fire(new PluginErrorEventCarrier(textMessage, settings, ExchangePluginResponseMapper.mapToPluginFaultResponse(FaultCode.EXCHANGE_TOPIC_MESSAGE.getCode(), "Error when receiving message in exchange " + e.getMessage())));
        }
    }
