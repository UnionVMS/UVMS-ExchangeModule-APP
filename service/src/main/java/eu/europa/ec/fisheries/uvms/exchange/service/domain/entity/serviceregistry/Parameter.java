...
@NamedQueries({
        ...
        @NamedQuery(name = "Parameter.findByParamDescription", query = "SELECT p FROM Parameter p WHERE p.description = :description"),
        @NamedQuery(name = "Parameter.findByParamValue", query = "SELECT p FROM Parameter p WHERE p.value = :value") })
public class Parameter implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return (this.paramId != null || other.paramId == null) && (this.paramId == null || this.paramId.equals(other.paramId));
    }
