...
package eu.europa.ec.fisheries.uvms.exchange.service.domain.constant;
...
public class ExchangeConstants {
    ...
    public static final String LOG_BY_LOGTYPE_AND_ONMESSAGE = "Log.findByLogTypeAndOnMessage";
