 ...
 * 2015-08-13T16:42:38.846+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "ExchangeModuleService", 
                  wsdlLocation = "file:/C:/Projekt/unionvms/branches/releases/eve/Modules/Exchange/APP/model/src/main/resources/contract/ExchangeModuleService.wsdl",
...
public class ExchangeModuleService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Projekt/unionvms/branches/releases/eve/Modules/Exchange/APP/model/src/main/resources/contract/ExchangeModuleService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExchangeModuleService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Projekt/unionvms/branches/releases/eve/Modules/Exchange/APP/model/src/main/resources/contract/ExchangeModuleService.wsdl");
        }
        WSDL_LOCATION = url;
    }
